             ...
             <div class="container">
              ...
              <script>
               ...
               dots[slideIndex-1].className += " active";
                    ...
                    <div class="">
                        <iframe src="//www.hava.one/widget/widget_frame?id=752850&days=9&textcolor=000&bcolor=fff&bkcolor=def2ff&hbkcolor=35a2e8&htcolor=000&w=200" scrolling="no" frameborder="0" style="border: radius 3px;border:1px solid black;overflow:hidden;height:415px;width:300px;border: radius 5px;" allowTransparency="true"></iframe>
